...
(function () {
  ...
  const translations = {
    ...
    es: {
      ...
      'lp.priv.sub': 'Cada decisión técnica fue tomada pensando en la seguridad de tus datos. Sin sorpresas, sin compromisos.',
      'lp.priv.1.title': 'Conversaciones que expiran en 10 minutos',
      'lp.priv.1.desc': 'Las sesiones de chat se eliminan automáticamente tras 10 minutos de inactividad. Nunca acumulamos historial de conversaciones de tu equipo.',
      'lp.priv.2.title': 'Máximo 12 mensajes en memoria',
      'lp.priv.2.desc': 'El historial tiene un límite estricto de 12 intercambios por sesión. Nunca construimos perfiles de conversación a largo plazo de tus empleados.',
      'lp.priv.3.title': 'Sin almacenamiento de conversaciones en bruto',
      'lp.priv.3.desc': 'Solo se conservan los documentos de tu base de conocimiento, accesibles únicamente por usuarios registrados de tu organización. Los archivos están cifrados de extremo a extremo — ni siquiera Rolplay puede acceder a su contenido.',
      'lp.priv.4.title': 'Control de permisos por consulta',
      'lp.priv.4.desc': 'Cada mensaje es clasificado por IA antes de acceder a cualquier documento. Los datos financieros, estratégicos y sensibles solo fluyen hacia roles autorizados.',
      'lp.priv.5.title': 'Identidad verificada por WhatsApp',
      'lp.priv.5.desc': 'Los usuarios son identificados por su número de WhatsApp verificado — sin contraseñas, sin cuentas que gestionar para los usuarios finales.',
      'lp.priv.6.title': 'Infraestructura de grado empresarial',
      'lp.priv.6.desc': 'Toda la infraestructura que sustenta Second Brain cumple con SOC 2 y está diseñada para entornos empresariales, con cifrado en reposo y en tránsito.',
      'lp.priv.trust.label': 'Construido sobre infraestructura empresarial conforme con SOC 2',
      ...
      'lp.priv.quote': '"Tus conversaciones son efímeras — los mensajes expiran en 10 minutos y el historial está limitado a 12 intercambios. Los documentos que subes están cifrados de extremo a extremo y solo son accesibles para los usuarios registrados de tu organización. Ni siquiera Rolplay puede leer su contenido."',
    ...
    en: {
      ...
      'lp.priv.sub': 'Every technical decision was made with your data\'s safety in mind. No surprises, no trade-offs.',
      'lp.priv.1.title': 'Conversations expire in 10 minutes',
      'lp.priv.1.desc': 'Chat sessions automatically delete after 10 minutes of inactivity. We never accumulate conversation history on your team.',
      'lp.priv.2.title': 'Max 12 messages in memory',
      'lp.priv.2.desc': 'History is hard-capped at 12 exchanges per session. Long-term conversation profiles of your employees are never built.',
      'lp.priv.3.title': 'No raw conversation storage',
      'lp.priv.3.desc': 'Only your uploaded knowledge base documents are retained, accessible exclusively by registered users in your organization. All files are end-to-end encrypted — even Rolplay cannot access their contents.',
      'lp.priv.4.title': 'Query-level permission gating',
      'lp.priv.4.desc': 'Every message is classified by AI before touching any document. Financial, strategic, and sensitive data only flows to authorized roles.',
      'lp.priv.5.title': 'WhatsApp-verified identity',
      'lp.priv.5.desc': 'Users are matched by their verified WhatsApp number — no passwords, no accounts, no credentials for end users to manage.',
      'lp.priv.6.title': 'Enterprise-grade infrastructure',
      'lp.priv.6.desc': 'All infrastructure powering Second Brain is built to enterprise-grade security standards, with encryption at rest and in transit.',
      'lp.priv.trust.label': 'Built on enterprise-grade, SOC 2 compliant infrastructure',
      ...
      'lp.priv.quote': '"Your conversations are ephemeral — messages expire in 10 minutes and history is capped at 12 exchanges. The documents you upload are end-to-end encrypted and accessible only to registered users in your organization. Not even Rolplay can read their contents."',
