...
(function () {
  ...
  const translations = {
    ...
    es: {
      ...
      "insights.error": "Error al cargar los insights. Intenta de nuevo.",
      "insights.no_messages": "No hay mensajes en este período para analizar.",
      "insights.no_summary": "No se pudo generar el resumen.",
      "insights.no_data": "Sin datos",
      "insights.no_gaps": "No se identificaron brechas de información.",
      "insights.no_topics": "No hay temas para mostrar.",
      "insights.blocks.title": "Segmentación por bloques",
      "insights.blocks.sub": "Cada mensaje se clasifica en 1 de 4 bloques",
      "insights.blocks.no_data": "No hay mensajes para segmentar en bloques.",
      "insights.blocks.msgs": "mensajes",
      "insights.queries": "consultas",
      "insights.chart_label": "Consultas",
      "insights.meta": "Generado: {when} · Mensajes analizados: {count}",
      "insights.meta_role": " · Rol: {role}",
      "insights.title": "Insights de Preguntas",
      "insights.subtitle": "Análisis de los temas más consultados por tu equipo",
      "insights.chart.topics": "Temas más frecuentes",
      "insights.chart.topics_sub": "Por número de consultas",
      "insights.gaps.title": "Posibles brechas de información",
      "insights.gaps.sub": "Temas consultados sin cobertura en la base de conocimiento",
      "insights.table.title": "Detalle de temas",
      "insights.col.topic": "Tema",
      "insights.col.count": "Consultas",
      "insights.col.pct": "% del total",
      "insights.col.examples": "Ejemplos",
      "insights.period.7": "Últimos 7 días",
      "insights.period.30": "Últimos 30 días",
      "insights.period.90": "Últimos 90 días",
      "insights.all_roles": "Todos los roles",
      ...
      "users.import.btn": "↑ Importar CSV",
      "users.import.modal_title": "Importar usuarios desde CSV",
      "users.import.description": "El CSV debe tener las columnas: <code>whatsapp_number</code>, <code>full_name</code>, <code>job_title</code>, <code>role_name</code>.<br>Solo <strong>whatsapp_number</strong> es obligatorio.",
      "users.import.download_template": "⬇ Descargar plantilla CSV",
      "users.import.cancel": "Cancelar",
      "users.import.submit": "Importar",
      "users.import.submitting": "Importando…",
      "users.import.select_file": "Selecciona un archivo CSV.",
      "users.import.error_network": "Error de red. Intenta de nuevo.",
      "users.import.error_generic": "Error al importar el archivo.",
      "users.import.col.row": "Fila",
      "users.import.col.whatsapp": "WhatsApp",
      "users.import.col.status": "Estado",
      "users.import.col.reason": "Razón",
      "users.import.summary.created": "✓ Creados",
      "users.import.summary.skipped": "⟳ Omitidos",
      "users.import.summary.failed": "✗ Errores",
      "users.import.summary.total": "Total",
    ...
    en: {
      ...
      "insights.error": "Error loading insights. Please try again.",
      "insights.no_messages": "No messages in this period to analyze.",
      "insights.no_summary": "Could not generate summary.",
      "insights.no_data": "No data",
      "insights.no_gaps": "No information gaps identified.",
      "insights.no_topics": "No topics to display.",
      "insights.blocks.title": "Block segmentation",
      "insights.blocks.sub": "Each message is classified into 1 of 4 blocks",
      "insights.blocks.no_data": "No messages to segment into blocks.",
      "insights.blocks.msgs": "messages",
      "insights.queries": "queries",
      "insights.chart_label": "Queries",
      "insights.meta": "Generated: {when} · Messages analyzed: {count}",
      "insights.meta_role": " · Role: {role}",
      "insights.title": "Question Insights",
      "insights.subtitle": "Analysis of the most frequently asked topics by your team",
      "insights.chart.topics": "Most frequent topics",
      "insights.chart.topics_sub": "By number of queries",
      "insights.gaps.title": "Possible information gaps",
      "insights.gaps.sub": "Topics queried without coverage in the knowledge base",
      "insights.table.title": "Topic details",
      "insights.col.topic": "Topic",
      "insights.col.count": "Queries",
      "insights.col.pct": "% of total",
      "insights.col.examples": "Examples",
      "insights.period.7": "Last 7 days",
      "insights.period.30": "Last 30 days",
      "insights.period.90": "Last 90 days",
      "insights.all_roles": "All roles",
      ...
      "users.import.btn": "↑ Import CSV",
      "users.import.modal_title": "Import users from CSV",
      "users.import.description": "The CSV must have the columns: <code>whatsapp_number</code>, <code>full_name</code>, <code>job_title</code>, <code>role_name</code>.<br>Only <strong>whatsapp_number</strong> is required.",
      "users.import.download_template": "⬇ Download CSV template",
      "users.import.cancel": "Cancel",
      "users.import.submit": "Import",
      "users.import.submitting": "Importing…",
      "users.import.select_file": "Please select a CSV file.",
      "users.import.error_network": "Network error. Please try again.",
      "users.import.error_generic": "Error importing the file.",
      "users.import.col.row": "Row",
      "users.import.col.whatsapp": "WhatsApp",
      "users.import.col.status": "Status",
      "users.import.col.reason": "Reason",
      "users.import.summary.created": "✓ Created",
      "users.import.summary.skipped": "⟳ Skipped",
      "users.import.summary.failed": "✗ Failed",
      "users.import.summary.total": "Total",
  ...
  window.setLang = function (lang) {
    applyLang(lang);
    if (window.customizeSettings && window.customizeSettings.persistLanguage) {
      window.customizeSettings.persistLanguage(lang);
    }
  };
